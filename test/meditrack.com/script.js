var targetToScrollTo = null;
  ...
  $(function () {
    var $parent = $('#sb-top-nav-3eb3c5fc-af7c-405d-b5eb-c1e3e1772456'),
    ...
    function toggleFixedNavigation () {
      ...
      if ($("#sb-id-3eb3c5fc-af7c-405d-b5eb-c1e3e1772456").hasClass("option-nav-fixed") || $navigationSection.hasClass("option-nav-fixed")) {
  ...
  adjustHeroPadding()
    ...
    var lastId,
      topMenu = $('#sb-nav-3eb3c5fc-af7c-405d-b5eb-c1e3e1772456'),
  ...
  $(function () {
    ...
    mq('(max-width: 767px)', function (match) {
      if ($("#sb-id-3eb3c5fc-af7c-405d-b5eb-c1e3e1772456").hasClass('option-nav-mobile-static') || $("#sb-navigation > .sb-section").hasClass('option-nav-mobile-static')) {
...
$(function() {
var $elem = $('[data-sb-uuid="c23a7b53-e9ef-41e2-b06f-b11a7ad8a1f3"]'),
...
window.addEventListener('load', () => {
  ...
  $(function() {
    b12.deferredRun("lightbox.runModal",{"className":".quick-view-2fa005d5-ba2e-4748-a1f1-4e00ac252e1b","classForTriggers":".quick-view-2fa005d5-ba2e-4748-a1f1-4e00ac252e1b-trigger","sectionClasses":["option-section-background-image-fixed","option-imagecrop-rectangle-landscape","option-imagesize-lg","option-animate-image-fade","option-link-decoration-border-bottom-static","option-grid-align-default","option-columns-2col","option-align-content-left"],"uuid":"2fa005d5-ba2e-4748-a1f1-4e00ac252e1b"});
  });